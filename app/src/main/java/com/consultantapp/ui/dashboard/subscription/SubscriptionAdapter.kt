...
import com.consultantapp.databinding.RvItemSubscriptionItemBinding
import com.consultantapp.utils.loadImage


class SubscriptionAdapter(private val fragment: SubscriptionListFragment, private val items: ArrayList<Packages>) :
        ...
        return if (viewType == ITEM) {
            ViewHolder(
                    DataBindingUtil.inflate(
                            ...
                            R.layout.rv_item_subscription_item, parent, false
                    )
            )
        } else {
            ViewHolderLoader(
    ...
    inner class ViewHolder(val binding: RvItemSubscriptionItemBinding) :
        ...
        fun bind(item: Packages) = with(binding) {
